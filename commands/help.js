...
module.exports.run = async (client, message, args) => {
    ...
    let help = new Discord.MessageEmbed()
      .setAuthor("Discord bot source by Rarry Ez")
      ...
      .addField("Check out", "[This Channel](https://www.youtube.com/channel/UCT_CM1zEg-zYq-nl1xHEQTg) For more discord bot source codes")
      .setTimestamp()
